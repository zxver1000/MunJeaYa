import "../style/studentmanage.scss";
  ...
  return (
    <div className="studentmanage">
      ...
      <aside className="left">
        <img className="studentmanage-image left" src={main_icon12_hover} />
      </aside>
      {/* pagename-main :: 해당 페이지의 주 내용 부분이 담기는 부분 */}
      <div className="studentmanage-main">
      ...
      <aside className="right">
        <Link to="/main">
          <img className="studentmanage-image right" src={main_icon12_hover} />
        </Link>
